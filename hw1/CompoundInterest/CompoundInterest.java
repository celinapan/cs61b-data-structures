...
public class CompoundInterest {
    ...
    static double futureValue(double presentValue, double rate,
                              int targetYear) {
        return presentValue * java.lang.Math.pow((1 + rate/100),numYears(targetYear));
    }
    ...
    static double futureValueReal(double presentValue, double rate,
        ...
        return futureValue(presentValue, rate, targetYear) * java.lang.Math.pow(1-inflationRate/100, numYears(targetYear));
    }
    ...
    static void printSavingsFV(int targetYear, double returnRate,
        ...
        double nominalSavings = totalSavings(10000, targetYear, returnRate);
        double realSavings =totalSavingsReal(10000, targetYear, returnRate, inflationRate);
