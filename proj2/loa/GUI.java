...
class GUI extends TopLevel implements View, Reporter {
    ...
    GUI(String title) {
        ...
        addMenuButton("Settings->Manual Black", this::switchManualBlack);
        addMenuButton("Settings->Manual White", this::switchManualWhite);
        addSeparator("Settings");
        addMenuButton("Settings->Auto Black", this::switchAutoBlack);
        addMenuButton("Settings->Auto White", this::switchAutoWhite);
        addMenuButton("Help->About", (s) -> displayText("About", ABOUT_TEXT));
        addMenuButton("Help->LOA", (s) -> displayText("Help", HELP_TEXT));
    ...
    /**
     * Response to "Player->manual white" button click.
     * @param s string to pass into queue
     */
    private void switchManualWhite(String s) {
        _pendingCommands.offer("manual white");
    }

    /**
     * Response to "Player->manual black" button click.
     * @param s string to pass into queue
     */
    private void switchManualBlack(String s) {
        _pendingCommands.offer("manual black");
    }

    /**
     * Response to "Player->auto white" button click.
     * @param s string to pass into queue
     */
    private void switchAutoWhite(String s) {
        _pendingCommands.offer("auto white");
    }

    /**
     * Response to "Player->auto black" button click.
     * @param s string to pass into queue
     */
    private void switchAutoBlack(String s) {
    ...
    public void update(Game controller) {
        ...
        display(manualBlack || manualWhite);
