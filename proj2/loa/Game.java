...
class Game {
    ...
    /** Retract last 2 moves */
    private void undo() {
        if (_board.movesMade() >= 2) {
            _board.retract();
            _board.retract();
            // currently replaces piece with
            // opposite piece instead of empty
            // issue with retract & isCapture being true always
        }
    }
