...
public class Main {
    ...
    public static void writeStory(String[] args) {
        ...
        // FIXME
        String s = Utils.readContentsAsString(Utils.join("story.txt", args));
        Utils.writeContents(Utils.join("story.txt", s));
    }
    ...
    public static void makeDog(String[] args) {
        ...
        // FIXME
        String[] info = {args[1], args[2], args[3]};
        Utils.writeObject(Dog.DOG_FOLDER.getParentFile(), info);
    }
    ...
    public static void celebrateBirthday(String[] args) {
        ...
        String[] bday = {args[1]};
        Utils.writeObject(Dog.DOG_FOLDER.getParentFile(), bday);
    }
